...
- [2A.1 系統概述](#-系統概述)
- [2A.2 環境需求](#-環境需求)
- [2A.3 快速開始 (自動模式)](#-快速開始-自動模式)
- [2A.4 實驗續跑 (Replay)](#-實驗續跑-replay)

#### (2B) Standalone 模式
- [2B.1 環境設定](#-環境設定)
- [2B.2 Standalone 模式 (無 Slurm)](#-standalone-模式-無-slurm)
- [2B.3 單元測試](#-單元測試)

### 三、驗證與補充
- [3.1 模型驗證說明](#-模型驗證說明)
- [3.2 監控與偵錯指南](#-監控與偵錯指南)
- [3.3 支援的聚合演算法](#-支援的聚合演算法)
...
## 4. 執行結果快照 (Execution Result Snapshot)
