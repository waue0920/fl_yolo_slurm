...
TRAIN_HYPERPARAMS="--batch-size 8 --epochs 50 --img 640 --device 0 --hyp ${WROOT}/yolov9/data/hyps/hyp.scratch-high.yaml --min-items 0 --close-mosaic 15 --workers 8"
...
for c in $(seq 1 ${CLIENT_NUM}); do
    ...
    SLURM_LOG_ERR="${EXP_DIR}/slurm_logs/client_${c}_round_${ROUND}.err"
